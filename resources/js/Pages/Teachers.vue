  ...
  <AuthenticatedLayout>
    ...
    <div class="p-8">
        ...
        <div v-if="viewType === 'grid'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div v-for="teacher in teachers" :key="teacher.id" class="bg-white rounded-2xl shadow p-6 flex flex-col items-center w-full max-w-xs mx-auto">
            ...
            <div class="flex gap-4 mt-2">
              ...
              <button @click="deleteTeacher(teacher.id)" class="w-10 h-10 flex items-center justify-center rounded-full bg-red-100 hover:bg-red-200 text-red-600 shadow transition">
      ...
      <Modal v-if="showEditModal" @close="showEditModal = false">
        <template #header>Teacher</template>
        <template #body>
          <div class="mb-4">
        ...
        <template #footer>
          <button @click="updateTeacher" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded">Save</button>
...
const teachers = ref([
  ...
  { id: 3, name: 'Emily Johnson', email: 'emily.johnson@example.com', avatar: '', },
  { id: 4, name: 'Michael Brown', email: 'michael.brown@example.com', avatar: '', },
  { id: 5, name: 'Sarah Lee', email: 'sarah.lee@example.com', avatar: '', },
  { id: 6, name: 'David Kim', email: 'david.kim@example.com', avatar: '', },
  { id: 7, name: 'Laura Wilson', email: 'laura.wilson@example.com', avatar: '', },
  { id: 8, name: 'James White', email: 'james.white@example.com', avatar: '', },
]);
