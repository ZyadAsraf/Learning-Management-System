    ...
    <div class="material-page p-8 bg-gray-100 min-h-screen">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                <!-- Material Header -->
                <div
                    class="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6"
                >
                ...
                <div v-if="loading || error" class="p-6">
                    <div
                        ...
                        :class="{
                            'border-t-4 border-blue-600': loading,
                            'border-t-4 border-red-500': error,
                        }"
                    >
                    ...
                    <section>
                        ...
                        <div v-if="material.pdf_path" class="grid gap-4">
                            ...
                            >
                                ...
                                <div class="mt-4 text-center">
                                    <span
                                        class="text-sm text-gray-500 bg-white px-3 py-1 rounded-full"
                                        >Click to open in new tab</span
                                    >
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-else class="text-center py-8">
                            ...
                            <p class="text-gray-500 text-lg">
                                No PDF material available for this course
                            </p>
                        </div>
                    </section>
                </div>
    ...
    data() {
        return {
            ...
            material: {
                ...
                description:
                    "This comprehensive material covers essential JavaScript concepts including variables, functions, objects, arrays, and modern ES6+ features like arrow functions, destructuring, promises, and async/await. Perfect for both beginners and intermediate developers looking to strengthen their JavaScript foundation.",
        ...
        async fetchMaterialData() {
            ...
            try {
                ...
                const response = await axios.get(
                    `/api/student/course/${this.course_id}/material/${this.material_id}`
                );
